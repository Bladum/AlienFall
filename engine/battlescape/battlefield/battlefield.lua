---Battlefield - Tactical Combat Map Management
---
---Core battlefield management system for turn-based tactical combat. Handles map
---generation, tile management, spatial operations, and terrain features. Provides
---optimized tile access, unit placement validation, and pathfinding support.
---
---Features:
---  - Procedural map generation with rooms and corridors
---  - 2D tile grid with BattleTile objects
---  - Terrain type management and movement costs
---  - Unit placement and collision detection
---  - Line-of-sight calculations
---  - Fog of war management
---  - Pathfinding support with terrain costs
---
---Key Exports:
---  - new(width, height): Create new battlefield instance
---  - getTile(x, y): Get tile at coordinates
---  - setTile(x, y, tile): Set tile at coordinates
---  - isValidPosition(x, y): Check if position is valid
---  - getNeighbors(x, y): Get adjacent tiles
---  - generateMap(): Create procedural map
---  - clearFog(x, y, radius): Reveal fog of war
---
---Dependencies:
...
---  local tile = battlefield:getTile(10, 10)
---
---@see battlescape.combat.battle_tile For tile data structure
---@see ai.pathfinding.tactical_pathfinding For pathfinding integration
