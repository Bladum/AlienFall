---HexSystem - Hex Grid Management System (ECS)
---
---Manages hex grid for tactical battlefield. Part of the ECS (Entity-Component-System)
---battle architecture. Handles hex coordinate system, tile data, pathfinding grid,
---and spatial queries.
---
---Features:
---  - Hex coordinate system (axial)
---  - Grid initialization and management
---  - Tile data storage (terrain, occupancy)
---  - Neighbor queries
...
---  - Pixel-perfect rendering at 24px hexsize
---
---Grid Data Structure:
---  - Width × Height grid of tiles
---  - Each tile stores: terrain type, occupancy, properties
---  - Spatial hash for fast queries
---
---Key Exports:
---  - HexSystem.new(width, height, hexSize): Creates hex grid
---  - getTile(q, r): Returns tile data
---  - setTile(q, r, data): Updates tile
---  - getNeighbors(q, r): Returns 6 adjacent hexes
---  - isWalkable(q, r): Returns true if passable
---  - inBounds(q, r): Returns true if valid coordinate
---
---Dependencies:
---  - battlescape.battle_ecs.hex_math: Hex utilities
---  - battlescape.battle_ecs.debug: Debug visualization
---
---@module battlescape.battle_ecs.hex_system
...
---  local grid = HexSystem.new(60, 60, 24)
---  local tile = grid:getTile(10, 15)
---
---@see battlescape.battle_ecs.hex_math For hex calculations
