---Legacy MapBlock Loader - Load and Filter MapBlocks by Tags
---
---Handles loading MapBlock files from mods and filtering by tags. Provides
---tag-based filtering, caching, and mod integration for legacy MapBlock system.
---Supports dynamic loading and fast tag-based lookups.
---
---Key Features:
---  - Loads MapBlocks from active mods
---  - Tag-based filtering and indexing
---  - Cache validation and invalidation
---  - Mod manager integration
---
---Key Exports:
---  - MapBlockLoader.new(modManager): Creates new loader instance
---  - MapBlockLoader:loadAll(): Loads all MapBlocks from mods
---  - MapBlockLoader:getBlocksByTags(tags): Filters blocks by tags
---  - MapBlockLoader:getBlock(id): Gets block by ID
---
---Dependencies:
---  - ModManager for mod content access
---
---@module legacy.mapblock_loader
