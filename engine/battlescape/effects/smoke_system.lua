---SmokeSystem - Smoke Propagation and Visibility Obstruction
---
---Manages smoke clouds with 3 intensity levels (light, medium, heavy) that spread
---to adjacent tiles and dissipate over time. Smoke creates sight penalties and
---affects tactical visibility. Generated by explosions, fire, and smoke grenades.
---
---Smoke Levels:
---  - Level 1 (Light): +2 sight cost, minimal obstruction
---  - Level 2 (Medium): +4 sight cost, moderate obstruction
---  - Level 3 (Heavy): +6 sight cost, severe obstruction
---
---Features:
---  - Multi-level smoke intensity system
---  - Natural dissipation over time
---  - Adjacent tile spread mechanics
---  - Sight cost penalties for line-of-sight
---  - Smoke grid optimization for fast lookups
---  - Integration with explosion and fire systems
---
---Key Exports:
---  - new(): Create new smoke system instance
---  - createSmoke(x, y, level, duration): Create smoke cloud
---  - dissipateSmoke(): Process smoke dissipation each turn
---  - spreadSmoke(): Process smoke propagation to adjacent tiles
---  - getSmokeLevel(x, y): Get smoke intensity at position
---  - getSightCost(x, y): Get additional sight cost from smoke
---  - update(dt): Update smoke durations and effects
---
---Dependencies:
---  - require("battlescape.battle_ecs.hex_math"): Hex coordinate calculations
---  - LOS system for sight cost integration
---
---@module battlescape.effects.smoke_system
...
---  smoke:createSmoke(10, 10, 3, 5)  -- Heavy smoke for 5 turns
---  local sightCost = smoke:getSightCost(10, 10)  -- Returns 6
---
---@see battlescape.effects.fire_system For smoke generation
---@see battlescape.effects.explosion_system For smoke creation
---@see battlescape.combat.los_system For sight calculations
