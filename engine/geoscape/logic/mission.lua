--[[
    ...
    Mission Types:
    - "site": Alien site (land-based)
    - "ufo": UFO (air or landed)
    - "base": Alien base (underground or underwater)
    ...
    Cover Mechanics:
    - Missions spawn with coverValue (0-100)
    - Cover regenerates daily at coverRegen rate
    - Radar scans reduce cover
    - When cover reaches 0, mission is detected
]]
