...
print("[Main] Loading New Campaign Wizard...")
local NewCampaignWizard = require("gui.scenes.new_campaign_wizard")

print("[Main] Loading Load Game Screen...")
local LoadGameScreen = require("gui.scenes.load_game_screen")

print("[Main] Loading Campaign Stats Screen...")
local CampaignStatsScreen = require("gui.scenes.campaign_stats_screen")
...
function love.load()
    ...
    StateManager.register("new_campaign_wizard", NewCampaignWizard)
