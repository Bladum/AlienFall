---Battlescape Screen - Tactical Combat
---
---Turn-based tactical combat game state on a 60×60 tile battlefield. Manages squad
---combat, fog of war, day/night cycle, team management, action resolution, and
---victory conditions. This is the core tactical gameplay layer.
---
---Key Features:
---  - 60×60 tile battlefield with multi-level terrain
---  - Turn-based combat with action point system
---  - Fog of war with line-of-sight calculations
---  - Team system (player, allies, enemies, neutral)
---  - Weapon systems (firearms, explosives, melee)
---  - Damage system with armor penetration
...
---
---Key Exports:
---  - Battlescape:enter(missionData): Initializes battlefield from mission
---  - Battlescape:update(dt): Updates combat state and systems
---  - Battlescape:draw(): Renders battlefield, units, and UI
---  - Battlescape:mousepressed(x, y, button): Handles tile selection and actions
---  - Battlescape:keypressed(key): Handles shortcuts and camera controls
---
---Dependencies:
---  - battlescape.battlefield.battlefield: Battlefield state management
---  - battlescape.combat.unit: Unit definitions and stats
---  - battlescape.combat.action_system: Action execution system
---  - battlescape.combat.damage_system: Damage calculation
---  - battlescape.effects.*: Fire, smoke, explosions, animations
---  - battlescape.rendering.*: Camera, rendering, effects
---  - ai.pathfinding.tactical_pathfinding: Pathfinding for movement
---  - core.team: Team and side management
---  - widgets.init: Combat UI widgets
---
---@module scenes.battlescape_screen
...
---  })
---
---@see battlescape.battlefield.battlefield For battlefield state
...
function Battlescape:showSkillSelection(unit, tileX, tileY)
    ...
    local SkillSelection = require("gui.widgets.display.skill_selection")
...
function Battlescape:executeMovementAction(moveMode, tileX, tileY)
    ...
    local MoveModeSystem = require("battlescape.battle_ecs.move_mode_system")
