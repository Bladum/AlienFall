...
--- Handles unit selection, movement range calculation, and path preview.
---
--- This module manages the tactical interface for selecting units, showing
--- movement ranges, and previewing movement paths. Integrates with action
--- system, pathfinding, and battlefield to provide visual feedback.
---
--- Example usage:
---   local unitSelection = UnitSelection.new(actionSystem, pathfinding, battlefield, turnManager)
---   unitSelection:selectUnit(unit, battlefield)
---   unitSelection:updateHover(mouseTileX, mouseTileY)

--- @class UnitSelection
--- @field actionSystem table Reference to ActionSystem
--- @field pathfinding table Reference to Pathfinding system
--- @field battlefield table Reference to Battlefield
...
--- @field movementPath table|nil Current path preview
--- @field hoveredTile table|nil Currently hovered tile {x, y}
--- @field visibleTiles table Tiles visible to selected unit
local UnitSelection = {}
...
--- @param pathfinding table Pathfinding instance
--- @param battlefield table Battlefield instance
...
---
--- Only allows selection of living units from the current team.
--- Calculates and stores movement range for UI display.
---
--- @param unit table Unit to select
--- @param battlefield table Battlefield instance
--- @return boolean True if unit was selected successfully
...
---
--- Deselects unit and clears movement range/path displays.
---
--- @return nil
...
---
--- Stores hovered tile coordinates and updates movement path preview
--- if a unit is selected and tile is in movement range.
---
--- @param tileX number|nil Tile X coordinate or nil to clear
--- @param tileY number|nil Tile Y coordinate or nil to clear
--- @param battlefield table|nil Battlefield instance (optional)
--- @param actionSystem table|nil ActionSystem instance (optional)
--- @param pathfinding table|nil Pathfinding instance (optional)
--- @return nil
...
--- Update movement path preview to target tile.
---
--- Calculates path from selected unit to target if target is in range.
--- Stores path for UI rendering.
---
--- @param targetX number Target tile X coordinate
--- @param targetY number Target tile Y coordinate
--- @return nil
