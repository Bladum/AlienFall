...
local Transform = require("battle.components.transform")
local Movement = require("battle.components.movement")
local Vision = require("battle.components.vision")
local Health = require("battle.components.health")
local TeamComponent = require("battle.components.team")
