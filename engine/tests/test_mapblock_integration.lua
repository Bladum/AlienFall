...
local success, TOML = pcall(require, "libs.toml")
if not success then
...
local success, MapBlock = pcall(require, "systems.battle.map_block")
if not success then
...
local success, GridMap = pcall(require, "systems.battle.grid_map")
if not success then
