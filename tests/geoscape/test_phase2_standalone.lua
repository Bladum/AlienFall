-- Standalone test for Phase 2 World Generation
-- Run with: lua tests/geoscape/test_phase2_standalone.lua
...
print("\n" .. string.rep("=", 70))
print("TASK-025 PHASE 2: WORLD GENERATION (Standalone Tests)")
print(string.rep("=", 70) .. "\n")
...
print("[TEST SUITE 1] WorldMap Unit Tests\n")
...
assert_true(stats.total_provinces == 3200, "Statistics report 3200 provinces")

-- ============================================================================
-- BiomeSystem Tests
-- ============================================================================

print("\n[TEST SUITE 2] BiomeSystem Unit Tests\n")
...
print("\n[TEST SUITE 3] ProceduralGenerator Integration Tests\n")
...
print("\n[TEST SUITE 4] LocationSystem Integration Tests\n")
...
result.world:forEachProvince(function(x, y, province)
    if province.region_id and province.region_id > 0 then
...
print("\n[TEST SUITE 5] GeoMap Wrapper Integration Tests\n")
