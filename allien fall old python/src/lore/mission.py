...
class TMission:
    ...
    Attributes:
        ...
        tech_end (List[str]): Technologies that end the mission.
        deployments (dict[str, dict]): Deployment options for the mission.
    """
    ufo: str | None
    site: str | None
    base: str | None
    ...
    def __init__(self, data: dict[str, str | int | float | list[str] | dict]) -> None:
        """
        Initialize a mission.

        Args:
            data (dict[str, str | int | float | list[str] | dict]): Mission data and parameters.
        """
