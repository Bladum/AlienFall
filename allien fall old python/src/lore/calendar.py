...
from lore.campaign_step import TCampaignStep
...
class TCalendar:
    ...
    def __init__(self, data: dict[str, Any] = None) -> None:
        ...
        Args:
            data (dict[str, Any]): Campaign step data per month (e.g., {"m01": {...}, ...}).
        """
        self.year: int = 2000
        self.month: int = 1
        self.day: int = 1
        self.total_days: int = 0
        self.campaign_months: dict[int, TCampaignStep] = {}
        if data is None:
            data = {}
        ...
        complete_months: dict[int, TCampaignStep] = {}
        last_month_data: TCampaignStep | None = None
        for i in range(120):
    ...
    def advance_days(self, n: int, *args, **kwargs) -> None:
        """
    ...
    def _advance_one_day(self, *args, **kwargs) -> None:
        """
    ...
    def on_day(self, *args, **kwargs) -> None:
        """Placeholder for daily logic."""
        pass

    def on_week(self, *args, **kwargs) -> None:
        """Placeholder for weekly logic."""
        pass

    def on_month(self, *args, **kwargs) -> None:
        """Placeholder for monthly logic."""
        pass

    def on_quarter(self, *args, **kwargs) -> None:
        """Placeholder for quarterly logic."""
        pass

    def on_year(self, *args, **kwargs) -> None:
        """Placeholder for yearly logic."""
        pass

    def generate_monthly_campaigns(self, month: int, research_status, all_campaigns: list[Any], all_factions: list[Any], worldmap: Any) -> list[dict[str, Any]]:
        """
    ...
    def daily_campaign_check(self, current_day: int, active_campaigns: list[dict[str, Any]], worldmap: Any) -> None:
        """
