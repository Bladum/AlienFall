...
class TItemTransferManager(QObject):
    ...
    def _default_validate_compatibility(self, item, slot) -> bool:
        """
    ...
    def start_drag(self, source_widget: QWidget, item, source_id: str) -> bool:
        """
    ...
    def can_accept_drop(self, target_widget: QWidget, target_id: str, mime_data: QMimeData) -> bool:
        ...
        if source_id == target_id and not target_widget.allow_self_drop:
            return False
    ...
    def accept_drop(self, target_widget: QWidget, target_id: str, mime_data: QMimeData) -> Tuple[bool, object, object]:
        """
        ...
        target_item = target_widget.item
    ...
    def get_item_compatibility_report(self, item, slot) -> dict:
        """
        ...
        Returns:
            dict: Dictionary with compatibility details:
