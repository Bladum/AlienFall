...
class TItemWeapon(TItem):
    ...
    Attributes:
        ...
        mode_params (dict[str, dict[str, int]]): Pre-calculated parameters for each mode.
    """
    ...
    def __init__(self, item_type_id: str, item_id: Optional[str] = None) -> None:
        ...
        self.ammo: int = self.item_type.unit_ammo  # Assume always present by type

        # Weapon mode support
        self.current_mode: str = 'snap'  # default mode

        # Pre-calculate all mode parameters
        self.mode_params: dict[str, dict[str, int]] = {}
        base_params = {
    ...
    def get_mode_params(self, mode_name: Optional[str] = None) -> dict[str, int]:
        """
        ...
        Returns:
            dict[str, int]: Mode parameters (ap_cost, range, accuracy, shots, damage).
        """
    ...
    def can_in_range(self, target_range: int) -> bool:
        """
    ...
    def can_fire(self, current_ap: int = 4) -> bool:
        """
    ...
    def get_stat_modifiers(self) -> 'TUnitStats':
        """
        Get stat modifiers provided by this weapon.
        Returns:
            TUnitStats: Stat modifiers affecting the unit.
        """
