...
class TCraftItem(TItem):
    ...
    def get_rearm_cost(self) -> int:
        ...
        Returns:
            int: Rearm cost.
        """
        return self.ammo_needed() * self.item_type.craft_rearm_cost
    ...
    def start_reload(self) -> None:
        ...
        """
        self.reload_time_left = self.item_type.craft_reload_time

    def start_rearm(self) -> None:
        """
        Start the rearm process for the item.
        """
        self.rearm_time_left = self.item_type.craft_rearm_time
    ...
    @classmethod
    def from_dict(cls, data: dict, game_instance) -> 'TCraftItem':
        """
