...
def facility(monkeypatch):
    ...
    import base.facility as facility_mod
...
def test_init_defaults(facility):
    ...
    assert isinstance(facility.facility_type, DummyFacilityType)
...
def test_facility_attributes():
    ...
    facility = ... # create or mock facility as needed
    _ = facility.facility_type
