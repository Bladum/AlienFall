...
class TBattleAI:
    ...
    """
    def __init__(self, battle_state: object):
        """
        ...
        """
        self.battle_state: object = battle_state

    def select_targets(self, unit: object) -> object:
        """
    ...
    def decide_movement(self, unit: object) -> object:
        """
