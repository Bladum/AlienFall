...
class TInventorySlot(QFrame):
    ...
    def __init__(
        ...
        # (REMOVED) Register with global registry for armor-dependent validation
        # Instead, parent should manage all slots and handle validation.
    ...
    def add_item(self, item: TItem, quantity: int = 1, emit_signal: bool = True) -> bool:
        ...
        if self.slot_type == EUnitItemCategory.ARMOR:
    ...
    def remove_item(self, quantity: Optional[int] = None, emit_signal: bool = True) -> Optional[TItem]:
        ...
        was_armor = self.slot_type == EUnitItemCategory.ARMOR
    ...
    def update_appearance(self) -> None:
        ...
        if self.locked and self.item:
            ...
            current_pixmap = QPixmap(self.item_label.pixmap())
    ...
    def can_accept_item(self, item: TItem) -> bool:
        """
        ...
        if self.slot_type is not None:
            ...
            elif self.accept_types and item.item_type in self.accept_types:
    ...
    def is_stackable(self, item: TItem) -> bool:
        """
