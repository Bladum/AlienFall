...
class TUnitListWidget(QWidget):
    ...
    def add_unit(self, unit: TUnit, icon_path: Optional[str] = None) -> bool:
        ...
        # Create icon
        icon_path = icon_path if icon_path else unit.icon_path
        icon = None
        if icon_path:
        ...
        unit_rank = unit.rank  # Assume rank is always present for TUnit
    ...
    def update_unit(self, updated_unit: TUnit):
        ...
        for unit_data in self.all_units:
            if unit_data['unit'].name == updated_unit.name:
                ...
                # Update display text
                unit_rank = updated_unit.rank  # Assume rank is always present for TUnit
