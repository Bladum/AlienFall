import unittest
from gui.other.widget.base_inventory_widget import TBaseInventoryWidget
from gui.other.widget.craft_list_widget import TCraftListWidget
from gui.other.widget.unit_item_list_widget import TUnitItemListWidget
from gui.other.widget.unit_list_widget import TUnitListWidget
