...
from battle.battle_floor import TBattleFloor
from battle.battle_object import TBattleObject
from battle.battle_roof import TBattleRoof
from battle.battle_wall import TBattleWall
...
class TBattleTile:
    ...
    def calculate_resistance(self, obj, damage_type):
        ...
        """
        if damage_type in obj.resistances:
