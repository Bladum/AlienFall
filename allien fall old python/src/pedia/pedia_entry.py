...
class TPediaEntry:
    ...
    def __init__(self, pid: str, data: dict[str, object]) -> None:
        ...
        Args:
            ...
            data (dict[str, object]): Dictionary containing entry data and metadata.
        Attributes:
            pid (str): Entry ID.
            ...
            related (list[str]): Related entries.
            stats (dict[str, Any]): Additional stats or metadata.
        """
        self.pid: str = pid
    ...
    def is_unlocked(self, unlocked_techs: list[str]) -> bool:
        """
        Check if the entry is unlocked based on available technologies.
        Args:
            unlocked_techs (list[str]): List of unlocked technology names/IDs.
        Returns:
