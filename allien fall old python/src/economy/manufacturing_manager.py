...
from economy.manufacturing_entry import TManufactureEntry  # Explicit type import
...
class ManufacturingManager:
    ...
    Attributes:
        active_projects (Dict[str, List[ManufacturingProject]]): Dictionary of base_id -> list of ManufacturingProject
        workshop_capacity (Dict[str, int]): Dictionary of base_id -> available workshop capacity
    """

    def __init__(self) -> None:
        """Initialize the manufacturing manager."""
        self.active_projects: Dict[str, List[ManufacturingProject]] = {}
        self.workshop_capacity: Dict[str, int] = {}

    def set_base_workshop_capacity(self, base_id: str, capacity: int) -> None:
        """
    ...
    def get_base_workshop_capacity(self, base_id: str) -> int:
        """Get total workshop capacity for a base."""
        return self.workshop_capacity.get(base_id, 0)

    def get_used_workshop_capacity(self, base_id: str) -> int:
    ...
    def get_available_workshop_capacity(self, base_id: str) -> int:
    ...
    def can_start_project(self, base_id: str, entry: TManufactureEntry, quantity: int, required_capacity: int = 1) -> Tuple[bool, str]:
        """
    ...
    def start_project(self, base_id: str, entry: TManufactureEntry, quantity: int, workshop_capacity: int = 1) -> Optional[ManufacturingProject]:
        """
    ...
    def change_project_quantity(self, project_id: str, new_quantity: int) -> Tuple[bool, str]:
        """
    ...
    def get_project(self, project_id: str) -> Optional[ManufacturingProject]:
    ...
    def has_active_project_of_type(self, base_id: str, entry_id: str) -> bool:
        """
    ...
    def get_base_projects(self, base_id: str, status: Optional[str] = None) -> List[ManufacturingProject]:
        """
    ...
    def _cleanup_completed_projects(self) -> None:
    ...
    def get_project_summary(self, base_id: str) -> dict:
        """
