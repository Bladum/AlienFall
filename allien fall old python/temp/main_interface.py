...
def load_template() -> None:
    ...
    from gui.widgets import validate_and_update_equipment_slots
...
def refresh_base_data() -> None:
    ...
    # Populate unit list
    if refresh_base_data.unit_list_widget:
...
def create_bottom_panel() -> QWidget:
    ...
    from gui.widgets import EquipmentSlotWidget, ItemListWidget, UnitListWidget
    ...
    src.gui.widgets.equipment_slots_global = equipment_slots_global
    src.gui.widgets.item_list_widget_global = item_list_widget_global
    src.gui.widgets.weight_label_global = weight_label_global
    src.gui.widgets.unit_inventory_manager_global = unit_inventory_manager
    src.gui.widgets.current_unit_global = current_unit_global
    src.gui.widgets.unit_info_label_global = unit_info_label_global
