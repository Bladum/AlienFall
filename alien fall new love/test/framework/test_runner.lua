...
function test_runner.discover_tests()
    ...
    -- Use explicit list instead of automatic discovery to avoid loading framework files
    test_files = {
        "test.data.test_data_loading",
        "test.data.test_data_registry",
        "test.engine.test_event_bus",
        ...
        "test.mods.test_mod_structure",
        "test.services.test_service_registry",
        "test.util.test_test_utilities",
        "test.util.test_toml_loader",
