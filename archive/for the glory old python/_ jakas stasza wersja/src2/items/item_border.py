...
class BorderItem(QGraphicsPathItem):
    def __init__(self, border_lines, prov_id_1, prov_id_2, parent=None):
        ...
        self.setZValue(gs.z_value_prov_border)
    ...
    def detect_border_type(self):
        ...
        prov1_data : Province = gs.provinces.get(self.prov_id_1)
        prov2_data : Province = gs.provinces.get(self.prov_id_2)
        ...
        owner_prov1 = gs.country_province_owner_dict.get(self.prov_id_1, "Unknown")
        owner_prov2 = gs.country_province_owner_dict.get(self.prov_id_2, "Unknown")
    ...
    def set_border_type(self, border_type):
        match border_type:
            case BorderType.PROVINCE:
                self.setPen(gs.pen_border_province)
                self.setZValue(gs.z_value_prov_border)
            case BorderType.SEA:
                self.setPen(gs.pen_border_sea)
                self.setZValue(gs.z_value_sea_border)
            case BorderType.COAST:
                self.setPen(gs.pen_border_coastal)
                self.setZValue(gs.z_value_coast_border)
            case BorderType.COUNTRY:
                self.setPen(gs.pen_border_country)
                self.setZValue(gs.z_value_country_border)
