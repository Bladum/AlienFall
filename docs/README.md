...
**Note:** There is also a `system/` folder in the project root containing universal system patterns (9 patterns) and project-specific modules documentation. See `../system/README.md` for details.
