...
sectoid_transformation_paths = {
  ...
  },
  {
    ...
    name = "Sectoid Ranger",
    type = "specialization",
    stat_bonus = {dexterity = 2, perception = 1},
  ...
  },
  {
    ...
    name = "Sectoid Elite",
    type = "advanced",
    stat_bonus = {strength = 2, will = 3, intelligence = 1},
    new_abilities = {"psi_lance", "mind_shield"},
    requirement = {kills = 100, missions = 10}
  },
  {
    level = 12,
    name = "Sectoid Commander",
    type = "elite",
    stat_bonus = {strength = 3, will = 5, intelligence = 3},
...
human_promotion_paths = {
  ...
  },
  {
    ...
    stat_bonuses = {accuracy = 0.05, will = 1}
  },
  {
    rank = 3,
    name = "Corporal",
    ...
    stat_bonuses = {accuracy = 0.1, will = 2, strength = 1},
  ...
  },
  {
    ...
    stat_bonuses = {accuracy = 0.15, will = 3, strength = 2},
    class_abilities = {
  ...
  },
  {
    ...
    stat_bonuses = {accuracy = 0.2, will = 4, strength = 3},
  ...
  },
  {
    ...
    stat_bonuses = {accuracy = 0.25, will = 5, strength = 4},
