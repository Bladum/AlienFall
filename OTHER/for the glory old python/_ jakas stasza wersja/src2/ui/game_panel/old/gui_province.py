...
from object.army import ArmyLand
...
class ProvincePanel(QWidget):
    ...
    def init_ui(self):
        ...
        self.infra_table = QTableWidget(len(gs.db_buildings), 4)
    ...
    def add_army_row(self, army_det : ArmyLand):
        ...
        image = gs.res_images['flag'].get(army_det.owner_tag + '.png')
    ...
    def setup_infra_table(self):
        ...
        if self.infra_table:
            ...
            for index, action in enumerate(gs.db_buildings.values()):
